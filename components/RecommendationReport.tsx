  ...
  return (
    <div className={styles.report}>
      ...
      <Section title="8 — Jurisdiction Scan" badge="AI-Assisted" defaultOpen={false}>
        <p className={styles.sectionExplanation}>
          Identifies real-world public sector implementations from Canadian, US, European, and global jurisdictions
          that are most closely aligned with this assessment&apos;s business problem, drivers, requirements, current state,
          and proposed solution. Results are generated by an AI model and require independent verification before use
